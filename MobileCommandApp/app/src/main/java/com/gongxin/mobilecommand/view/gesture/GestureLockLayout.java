package com.gongxin.mobilecommand.view.gesture;
...
//                    return new QQLockView(context);
        ...
        mPaint.setStrokeWidth(DensityUtil.dip2px(context, mStrokeWidth));
    ...
    public void setPathWidth(float dp) {
        mPaint.setStrokeWidth(DensityUtil.dip2px(getContext(), dp));
    }
